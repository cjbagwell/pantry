...
public class RemoveIngredientActivity extends AppCompatActivity implements RemoveIngredientPopUpDialog.RemoveIngredientPopUpDialogListener {
            ...
            public void onDetectionTaskReceived(@NonNull Task<List<Barcode>> task) {
                ...
                task.addOnSuccessListener(new OnSuccessListener<List<Barcode>>() {
                    ...
                    public void onSuccess(List<Barcode> barcodes) {
                        ...
                        // Process the result with a pop up dialog
                        setResult(manager.getIngredient(barcodes.get(0).getRawValue()));
                    }
                });
    ...
    public void openPopUpDialog(Ingredient ingredient) {
        ...
        RemoveIngredientPopUpDialog popUpDialog = new RemoveIngredientPopUpDialog();
